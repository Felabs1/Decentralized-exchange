  ...
  return (
    <article className="flex flex-col bg-[#212429]">
      <a
        ...
        href="#"
        aria-label="Te  ulla oportere reprimique his dolorum"
      >
        <img
          alt=""
      ...
      <div className="flex flex-col flex-1 p-6">
        <a
          rel="noopener noreferrer"
          href="#"
          aria-label="te nulla oportere repremique his dolorum"
        ></a>
        <a
          rel="noopener noreferrer"
          href="#"
        ...
        <h3 className="flex-1 py-2 text-lg font-semibold leadi"></h3>
