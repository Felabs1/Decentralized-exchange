...
contract CustomDex {
    string[] public tokens =  ["tether USD", "BNB", "USD Coin", "stETH", "TRON", "MATIC", "SHIBA INU", "Uniswap"];
...
function swapEthToken(string memory tokenName) public payable returns (uint256){
